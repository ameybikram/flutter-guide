...
class Question extends StatelessWidget {
  ...
  Question(this.questionText); //Constructor which is contains a placed parameter and whatever value here string type is passed to this class is set to the class variable just like as in the below example
// class Person{
//   String name;
//   int age;
